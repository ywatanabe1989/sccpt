...
# -*- coding: utf-8 -*-
"""
GIF creation functionality for SCCPT.
...
class GifCreator:
    ...
    def create_gif_from_session(self,
                               session_id: str,
                               output_path: Optional[str] = None,
                               screenshot_dir: str = "~/.cache/sccpt",
                               duration: float = 0.5,
                               optimize: bool = True,
    ...
    def create_gif_from_files(self,
                             image_paths: List[str],
                             output_path: str,
                             duration: float = 0.5,
                             optimize: bool = True,
                             loop: int = 0) -> Optional[str]:
        """
        ...
        try:
            ...
            if output_path.exists():
                ...
                print(f"📹 GIF created: {output_path} ({len(images)} frames, {file_size:.1f}KB)")
    ...
    def get_recent_sessions(self, screenshot_dir: str = "~/.cache/sccpt") -> List[str]:
        """
    ...
    def create_gif_from_recent_session(self,
                                      screenshot_dir: str = "~/.cache/sccpt",
                                      duration: float = 0.5,
                                      optimize: bool = True,
                                      max_frames: Optional[int] = None) -> Optional[str]:
...
def create_gif_from_files(image_paths: List[str], output_path: str, **kwargs) -> Optional[str]:
