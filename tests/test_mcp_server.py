...
class TestCAMMCPServer:
    ...
    def temp_cache_dir(self):
        ...
        cache_dir = Path(temp_dir) / ".cache" / "cam"
    ...
    async def test_start_monitoring(self, client, temp_cache_dir):
        ...
        with patch('mcp_server_fastmcp.cam.start_monitor') as mock_start:
    ...
    async def test_stop_monitoring(self, client, temp_cache_dir):
        ...
        with patch('mcp_server_fastmcp.cam.stop') as mock_stop:
...
class TestMCPServerIntegration:
    """Integration tests for MCP server with real cam functionality."""
